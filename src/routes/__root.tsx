...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "partystack — celebration infrastructure" },
      { property: "og:description", content: "Curated parties, vendors, and printable kits for urban India." },
