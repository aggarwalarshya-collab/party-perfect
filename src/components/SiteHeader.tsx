    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 md:px-8 md:py-4">
        <Link to="/" onClick={() => setOpen(false)} className="flex items-center gap-3">
          ...
          <div className="leading-none">
            <div className="font-display text-xl font-semibold tracking-tight md:text-2xl">
              House of <span className="italic text-sparkle">Affairs</span>
            </div>
        ...
        <div className="flex items-center gap-2">
          <Link
            to="/assistant"
            className="hidden rounded-full bg-oxblood px-4 py-2 text-xs font-medium text-primary-foreground shadow-soft ring-1 ring-champagne/40 transition hover:opacity-95 md:inline-block md:text-sm md:px-5"
          >
            Plan an affair
          </Link>
          <button
            ...
            <ul className="grid gap-1">
              ...
              <li className="pt-2">
                <Link
                  to="/assistant"
                  onClick={() => setOpen(false)}
                  className="block rounded-full bg-oxblood px-4 py-3 text-center text-sm font-medium text-primary-foreground ring-1 ring-champagne/40"
                >
                  Plan an affair →
                </Link>
              </li>
