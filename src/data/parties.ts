...
export const parties: Party[] = [
  {
    ...
    vendors: [
      { slug: "skyline-sutra", name: "Cinema At Home Co.", role: "Projector + screen", price: "₹4,000" },
      { slug: "grazing-plate", name: "The Grazing Plate", role: "Popcorn + snack bar", price: "₹3,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "maison-noir", name: "Greens & Grain Co.", role: "Putting green + setup", price: "₹9,000" },
      { slug: "skyline-sutra", name: "Skyline Sutra", role: "Whisky pairing bar", price: "₹8,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "grazing-plate", name: "Casa Cantina", role: "Taco + salsa station", price: "₹11,500" },
      { slug: "skyline-sutra", name: "Margarita Bar Co.", role: "Bartender + bar", price: "₹6,500" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "chef-anaya", name: "Calm Co. Yoga", role: "Instructor + mats", price: "₹8,500" },
      { slug: "grazing-plate", name: "Matcha Maison", role: "Matcha bar + bites", price: "₹6,500" },
      { slug: "petal-wax", name: "Pup Pals", role: "Therapy puppies (3)", price: "₹5,500" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "skyline-sutra", name: "The Stir Co.", role: "Master mixologist + bar", price: "₹16,000" },
      { slug: "maison-noir", name: "Habano House", role: "Cigar curator + humidor", price: "₹12,000" },
      { slug: "chef-vikrant", name: "Chef Vikrant", role: "Bar bites + canapés", price: "₹8,500" },
    ],
  },  {
    slug: "diwali-baithak",
    ...
    vendors: [
      { slug: "marigold-lane", name: "Marigold Lane", role: "Decor + diyas", price: "₹23,000" },
      { slug: "chatori-galli", name: "Chatori Galli", role: "Mithai + chaat counter", price: "₹14,500" },
      { slug: "dholwala-bros", name: "Dholwala Bros.", role: "Sufi musicians", price: "₹11,500" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "maison-noir", name: "Maison Noir", role: "Floor seating + drapes", price: "₹14,500" },
      { slug: "chef-vikrant", name: "Chef Vikrant", role: "Kebab counter", price: "₹11,500" },
      { slug: "vinyl-hours", name: "Sufi Trio", role: "Tabla · harmonium · vocals", price: "₹10,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "bloom-arch", name: "Bloom & Arch Co.", role: "Balloon installation", price: "₹24,500" },
      { slug: "grazing-plate", name: "The Grazing Plate", role: "Charcuterie tower", price: "₹9,000" },
      { slug: "lumen-lens", name: "Lumen Lens", role: "Photographer", price: "₹10,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "skyline-sutra", name: "Skyline Sutra", role: "Rooftop styling", price: "₹4,000" },
      { slug: "petal-wax", name: "Petal & Wax", role: "Florals + candles", price: "₹2,500" },
      { slug: "chef-anaya", name: "Chef Anaya", role: "Private chef", price: "₹4,000" },
    ],
  },
    {
    slug: "proposal-setup",
    ...
    vendors: [
      { slug: "petal-wax", name: "Petal & Wax", role: "Petals + candle wall", price: "₹6,000" },
      { slug: "lumen-lens", name: "Lumen Lens", role: "Hidden photographer", price: "₹5,500" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "confetti-co", name: "Confetti Co.", role: "Balloon styling", price: "₹9,000" },
      { slug: "sugar-sundays", name: "Sugar Sundays", role: "Donut tower + cake", price: "₹6,000" },
      { slug: "disco-diaries", name: "Disco Diaries", role: "DJ + lights", price: "₹7,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "maison-noir", name: "Maison Noir", role: "Poker table + styling", price: "₹9,000" },
      { slug: "chef-vikrant", name: "Chef Vikrant", role: "Chef's bar bites", price: "₹10,500" },
      { slug: "skyline-sutra", name: "Skyline Sutra", role: "Bartender + whisky pairing", price: "₹5,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "tiny-tents", name: "Tiny Tents", role: "Decor + arch", price: "₹9,000" },
      { slug: "frosted-studio", name: "Frosted Studio", role: "Custom cake", price: "₹4,000" },
      { slug: "kiddo-carnival", name: "Kiddo Carnival", role: "Entertainer + games", price: "₹6,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "maison-noir", name: "Maison Noir", role: "Tablescape + styling", price: "₹17,000" },
      { slug: "chef-vikrant", name: "Chef Vikrant", role: "5-course chef", price: "₹21,000" },
      { slug: "vinyl-hours", name: "Vinyl Hours", role: "Acoustic duo", price: "₹9,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "chef-vikrant", name: "Chef Vikrant", role: "6-course tasting menu", price: "₹34,000" },
      { slug: "maison-noir", name: "Maison Noir", role: "Marble setup + service", price: "₹11,500" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "vinyl-hours", name: "Vinyl Hours", role: "Karaoke + jam setup", price: "₹8,000" },
      { slug: "skyline-sutra", name: "Bartender", role: "Mixers + wine", price: "₹5,000" },
    ],
  },
    {
    slug: "house-warming",
    ...
    vendors: [
      { slug: "bloom-arch", name: "Bloom & Arch Co.", role: "Floral console + drapes", price: "₹14,500" },
      { slug: "grazing-plate", name: "The Grazing Plate", role: "Cheese + grazing table", price: "₹10,500" },
      { slug: "skyline-sutra", name: "Champagne Tower Co.", role: "Bar + tower", price: "₹9,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "petal-wax", name: "Petal & Wax", role: "Florals + candles", price: "₹5,000" },
      { slug: "chef-anaya", name: "Glow Therapy Co.", role: "On-call therapists (2)", price: "₹9,000" },
    ],
  },
    {
    ...
    vendors: [
      { slug: "bloom-arch", name: "Bloom & Arch Co.", role: "Garland + tablescape", price: "₹14,500" },
      { slug: "grazing-plate", name: "The Grazing Plate", role: "Brunch + grazing", price: "₹13,000" },
      { slug: "chef-anaya", name: "Chef Anaya", role: "Roast + dessert course", price: "₹9,000" },
    ],
  },
    {
    slug: "onam-sadhya",
    ...
    vendors: [
      { slug: "chatori-galli", name: "Sadhya Stories", role: "26-item sadhya catering", price: "₹17,000" },
      { slug: "marigold-lane", name: "Marigold Lane", role: "Pookalam + brass diyas", price: "₹9,000" },
    ],
  },
...
export const vendors: Vendor[] = [
  ...
  },
  {
    ...
    packages: [
      { name: "Live kebab counter", price: "₹18,000", includes: "3 kebabs · live grill · chutneys (10 guests)" },
      { name: "6-course chef's table", price: "₹52,000", includes: "6 courses · plating · service (8-12 guests)" },
    ],
  },
  {
    slug: "maison-noir",
    ...
    packages: [
      { name: "Intimate tablescape", price: "₹22,000", includes: "Linen · candlesticks · service ware (10)" },
      { name: "Full noir dinner", price: "₹78,000", includes: "Tables · seating · drapes · florals · service" },
    ],
  },
  {
    slug: "skyline-sutra",
    ...
    packages: [
      { name: "Date night rooftop", price: "₹6,000", includes: "Styling · candles · fairy lights · setup" },
      { name: "Bar + bartender", price: "₹14,000", includes: "Bartender · 3 cocktails · glassware (15 guests)" },
    ],
  },
  {
    slug: "petal-wax",
    ...
    packages: [
      { name: "Proposal setup", price: "₹9,500", includes: "Petal heart · 100 candles · ring stand" },
      { name: "Anniversary table florals", price: "₹3,500", includes: "Centerpiece · taper candles · place posies" },
    ],
  },
  {
    slug: "grazing-plate",
    ...
    packages: [
      { name: "Charcuterie tower (15)", price: "₹14,000", includes: "Cheese · meats · crackers · seasonal fruit" },
      { name: "Full grazing table (30)", price: "₹26,000", includes: "8ft table · cheese · meats · dips · fruit" },
    ],
  },
  {
    slug: "lumen-lens",
    ...
    packages: [
      { name: "Hidden photographer (proposal)", price: "₹8,500", includes: "2 hours · 60 edited photos · reel" },
      { name: "Full event coverage (4hr)", price: "₹15,000", includes: "150 edited photos · highlight reel" },
    ],
  },
  {
    slug: "chatori-galli",
    ...
    packages: [
      { name: "Mithai + chaat counter (25)", price: "₹22,000", includes: "5 mithai · 3 chaats · live chef" },
      { name: "Full festive thali (40)", price: "₹48,000", includes: "Thali service · mithai · drinks" },
    ],
  },
  {
    slug: "dholwala-bros",
    ...
    packages: [
      { name: "Sufi trio (2 hrs)", price: "₹18,000", includes: "Tabla · harmonium · vocals" },
      { name: "Sangeet dhol set", price: "₹12,000", includes: "2 dholis · 1 hr · entry + sangeet" },
    ],
  },
  {
    slug: "vinyl-hours",
    ...
    packages: [
      { name: "Karaoke + jam setup", price: "₹12,000", includes: "Mic · speakers · 200-song library" },
      { name: "Acoustic duo (3 hrs)", price: "₹14,000", includes: "Guitar + vocals · sound · 3 hr set" },
    ],
  },
  {
    slug: "disco-diaries",
    ...
    packages: [
      { name: "DJ + lights (3 hrs)", price: "₹11,000", includes: "DJ · 4 disco lights · sound system" },
      { name: "Full dancefloor", price: "₹26,000", includes: "DJ · LED dancefloor · lights · smoke" },
    ],
  },
  {
    slug: "sugar-sundays",
    ...
    packages: [
      { name: "Donut tower + cake (10)", price: "₹9,500", includes: "30 donuts · 1kg cake · stand" },
      { name: "Dessert table (25)", price: "₹22,000", includes: "Cake · donut tower · macarons · cupcakes" },
    ],
  },
  {
    slug: "tiny-tents",
    ...
    packages: [
      { name: "Birthday arch + decor", price: "₹14,000", includes: "Arch · backdrop · table styling" },
      { name: "Sleepover (6 tents)", price: "₹22,000", includes: "Tents · linens · fairy lights · breakfast styling" },
    ],
  },
  {
    slug: "frosted-studio",
    ...
    packages: [
      { name: "1kg custom cake", price: "₹6,500", includes: "Theme · hand-painted · 1kg" },
      { name: "Tiered cake (3kg)", price: "₹14,000", includes: "3 tiers · theme · sugar flowers" },
    ],
  },
  {
    slug: "kiddo-carnival",
    ...
    packages: [
      { name: "Entertainer (2 hrs)", price: "₹9,000", includes: "Magician · balloon art · games" },
      { name: "Full carnival (3 hrs)", price: "₹18,000", includes: "3 entertainers · games · prizes" },
    ],
  },
];
